  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-muted/30 border-b">
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight text-balance">
                Tez-tez Verilən Suallar
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground text-pretty max-w-2xl">
                Sifarişlər, çatdırılma və məhsullar haqqında ən çox maraqlandıran sualların cavablarını sizin üçün topladıq.
              </p>
            </div>
          </div>
        </section>
        ...
        <main className="flex-1 container mx-auto px-4 py-16 md:py-24">
          ...
          <div className="mt-24 p-8 md:p-12 bg-gradient-to-br from-primary/5 via-muted/50 to-background rounded-3xl text-center border shadow-sm max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Başqa sualınız qaldı?</h3>
            <p className="text-lg text-muted-foreground mb-8 max-w-lg mx-auto">
              Axtardığınız cavabı tapa bilmədinizsə, bizə yazın. Müştəri xidmətlərimiz sizə dərhal kömək etməyə hazırdır.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-xl bg-[#25D366] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#25D366]/25 transition-all hover:bg-[#128C7E] hover:shadow-xl hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
