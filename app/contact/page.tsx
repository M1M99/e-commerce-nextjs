        ...
        <section className="bg-muted/50 border-b">
          <div className="container mx-auto px-4 py-12 md:py-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl text-pretty">
              Have questions? Want to place an order? Contact us via WhatsApp for instant support.
            </p>
          </div>
        </section>
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>Fast response, easy ordering</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4 text-pretty">
                    Contact us directly on WhatsApp for instant support, order placement, and product inquiries.
                  </p>
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>We deliver across Baku</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-pretty">
                    ...
                    <br />
                    Fast delivery available across all districts of Baku
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="font-semibold">Fast Delivery</strong>
                        <p className="text-sm text-muted-foreground text-pretty">
                          Quick delivery across Baku, Azerbaijan
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="font-semibold">Easy Ordering</strong>
                        <p className="text-sm text-muted-foreground text-pretty">
                          Simple ordering process via WhatsApp
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="font-semibold">Quality Products</strong>
                        <p className="text-sm text-muted-foreground text-pretty">
                          Carefully selected high-quality items
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground text-pretty">Cash on delivery for your safety</p>
                      </div>
                    </li>
                  </ul>
                </CardContent>
